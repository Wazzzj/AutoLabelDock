...
class AnnotationPanel(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        classes_layout.setContentsMargins(8, 6, 8, 8)
        ...
        attr_layout.setContentsMargins(8, 6, 8, 8)
        ...
        for hidden_name in ("项目类别", "属性"):
            self._sections[hidden_name].setVisible(False)
        outer.addStretch(1)
    ...
    def _rebalance_sections(self) -> None:
        """Refresh compact section heights after expand/collapse."""
        self._sync_annotation_tree_height()
        self.updateGeometry()
    ...
    def save_state(self) -> dict:
        """Snapshot per-section collapsed flags."""
        return {
            "collapsed": {
    ...
    def set_annotations(self, annotations: list[Annotation]) -> None:
        ...
        for ann in annotations:
            ...
            type_hint = ""
            if ann.polygon:
                type_hint = f" [poly\u00d7{len(ann.polygon)}]"
