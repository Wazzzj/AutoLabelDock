"""Global application configuration (config/config.json)."""
...
DEFAULT_APP_CONFIG_PATH = CONFIG_DIR / "config.json"
DEFAULT_TRAIN_TEMPLATES_PATH = CONFIG_DIR / "train_templates.json"
DEFAULT_WINDOW_GEOMETRY = {"x": 120, "y": 90, "width": 1180, "height": 760}
...
class AppConfig:
    ...
    window_geometry: dict[str, int] = field(
        default_factory=lambda: dict(DEFAULT_WINDOW_GEOMETRY)
    )
    ...
    last_train_config: dict = field(default_factory=dict)
    model_panel_config: dict = field(default_factory=dict)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "last_train_config": self.last_train_config,
            "model_panel_config": self.model_panel_config,
    ...
    def from_dict(cls, d: dict) -> AppConfig:
        ...
        return cls(
            ...
            window_geometry=d.get("window_geometry", dict(DEFAULT_WINDOW_GEOMETRY)),
            ...
            last_train_config=d.get("last_train_config", {}) if isinstance(d.get("last_train_config", {}), dict) else {},
            model_panel_config=d.get("model_panel_config", {}) if isinstance(d.get("model_panel_config", {}), dict) else {},
            script_tools=d.get("script_tools", {}) if isinstance(d.get("script_tools", {}), dict) else {},
